...
<HEAD>
	...
	// ============================================
	// SCRIPTS PARA PANEL FULFILLMENT
	// ============================================
        echo "<script src='https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js'></script>";
        echo "<script src='assets/js/excel-lite.js?$aleatorio'></script>";
	echo "<link rel='stylesheet' type='text/css' href='assets/css/styles.css?$aleatorio'>";
	echo "<script type='text/javascript' src='assets/js/app.js?$aleatorio'></script>";
	// ============================================
...
<body>
	...
	<div class="card border-0">
		...
		<!-- ============================================ -->
		<!-- INICIO: CONTENIDO DE TU INDEX.HTML          -->
		<!-- ============================================ -->
		<div>
		      ...
		      <section class="content-tabs">
		        ...
		        <div class="tabs-content">
		          <div class="tab-panel active" id="zonasPanel">
		            <div class="loading-message">
		              <p>Los datos de zonas aparecerán aquí</p>
		            </div>
		          </div>

		          <div class="tab-panel" id="cmtsPanel">
		            <div class="loading-message">
		              <p>Los datos agrupados por CMTS aparecerán aquí</p>
		            </div>
		          </div>

		          <div class="tab-panel" id="edificiosPanel">
		            <div class="loading-message">
		              <p>Los datos de edificios aparecerán aquí</p>
		            </div>
		          </div>

		          <div class="tab-panel" id="equiposPanel">
		            <div class="loading-message">
		              <p>Los equipos por zona aparecerán aquí</p>
		            </div>
		          </div>
		        </div>
		      </section>
		...
		<!-- ============================================ -->
		<!-- FIN: CONTENIDO DE TU INDEX.HTML             -->
		<!-- ============================================ -->
